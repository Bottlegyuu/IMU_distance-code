...
class DistanceEstimation:
    ...
    def classify_floor(self, distance_z, initial_position):
        ...
        if 3.0 < distance_z < 4.5:
            initial_position += 1
        elif 4.5 <= distance_z < 9.5:
            initial_position += 2
        elif 9.5 <= distance_z < 13.5:
            initial_position += 3
        elif 13.5 <= distance_z < 18.0:
            initial_position += 4
        elif 18.0 <= distance_z < 25.0:
            initial_position += 5
        elif 25.0 <= distance_z < 32.0:
            initial_position += 6
        elif 32.0 <= distance_z < 39.0:
            initial_position += 7
        elif 39.0 <= distance_z < 100.0:
            initial_position += 8
        elif -2.1 > distance_z > -4.5:
            initial_position -= 1
        elif -4.5 >= distance_z > -9.5:
            initial_position -= 2
        elif -9.5 >= distance_z > -13.5:
