...
class DistanceEstimation:
    ...
    def imu_callback(self, imu_msg):
        ...
        # Set linear_acceleration_z to 9.6 if it's between 9.5 and 9.8
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if distance_z is not None:
            ...
            if floor_estimation.distance_estimation.over_flag == False or floor_estimation.distance_estimation.under_flag == False:
                timestamp = rospy.Time.now().to_sec()
